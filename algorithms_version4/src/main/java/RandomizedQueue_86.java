 ...
 * @Date 2024/7/8 23:19
 **/
public class RandomizedQueue_86<Item> implements Iterable<Item> {
...
//        System.out.println("SIZE:" + size + " index:" + uniformIndex);
    ...
    public static void main(String[] args) {
        ...
        RandomizedQueue_86<String> queue = new RandomizedQueue_86<>();
        while (!StdIn.isEmpty()) {
    ...
    private static void printArr(RandomizedQueue_86<String> queue) {
